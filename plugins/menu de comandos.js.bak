...
conn.send3ButtonImg(m.chat, pp, menu, '©Alex Bot 9.0 - Bot', 'Alex Bot 9.0', `#menusimple`, 'Info B', `#menuaudios`, '𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂', `#grupos`, m, false, { contextInfo: { mentionedJid }})   
